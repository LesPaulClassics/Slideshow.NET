...
//				this._listViewImages.SelectedIndex--;
		...
		private void InitializeComponent()
		{
            ...
            this.setting = new System.Windows.Forms.ColumnHeader();
            ...
            // buttonTest
            // 
            this.buttonTest.Location = new System.Drawing.Point(302, 124);
...
//			MessageBox.Show("Keyword String = " + testItem.KeywordString);
		...
		private void button3_Click(object sender, System.EventArgs e)
		{
			...
			sf.ImageItemCollection.AddImageItem( _images[0]);
			sf.ImageItemCollection.AddImageItem( _images[1]);
			sf.ImageItemCollection.AddImageItem( _images[2]);
			sf.ImageItemCollection.AddImageItem( _images[3]);
			sf.ImageItemCollection.AddImageItem( _images[4]);
			...
			sf2.ImageItemCollection.AddImageItem( _images[5]);
			sf2.ImageItemCollection.AddImageItem( _images[6]);
			sf2.ImageItemCollection.AddImageItem( _images[7]);
			sf2.ImageItemCollection.AddImageItem( _images[8]);
			sf2.ImageItemCollection.AddImageItem( _images[9]);
			...
			sf3.ImageItemCollection.AddImageItem( _images[10]);
			sf3.ImageItemCollection.AddImageItem( _images[11]);
			sf3.ImageItemCollection.AddImageItem( _images[12]);
			sf3.ImageItemCollection.AddImageItem( _images[13]);
			sf3.ImageItemCollection.AddImageItem( _images[14]);
...
//			}
			...
			for (int i = 0; i < _cf.ScriptFileList.Count; i++)
			{
				...
				ListViewItem item = new ListViewItem(_cf.ScriptFileList[i].FileName);
        ...
        private void PopulateListViewImages(ScriptFile sf, int i)
        {
            foreach (ImageItem ii in sf.ImageItemCollection)
            {

                //this._listViewImages.Items.Add(ii.PathAndFileName);
                ListViewItem lvi = new ListViewItem(new String[] { ii.FileName, ii.KeywordString, ii.FilePath });
                lvi.Tag = ii.Index;
        ...
        private void buttonTest_Click(object sender, EventArgs e)
        {
            foreach (ListViewItem lvi in _listViewImages.SelectedItems)
            {
                ...
                _images[(int)lvi.Tag].AddKeywords(temp);
            }
            ...
            for (int i = 0; i < 15; i++)
            {
                sBldr.Append(String.Format("{0} : {1}", i, _images[i].KeywordString));
                sBldr.Append("\r\n");
            }
            MessageBox.Show(sBldr.ToString());
        }
    }
}
