...
namespace TSOP.SlideShow
{
	...
	public class KeywordEditForm : System.Windows.Forms.Form
	{
		...
		public KeywordEditForm()
		{
			...
			_selectedKeywords = new ArrayList(1);
		...
		{
			this._lstKeywords.SelectedIndex = -1;
		}
		...
		private void GetSelectedKeywords()
		{
			...
			_selectedKeywords = new ArrayList(_lstKeywords.SelectedIndices.Count);
		...
		private ArrayList _selectedKeywords;
		...
		public ArrayList SelectedKeywords
		{
			get
			{
